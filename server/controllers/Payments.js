...
exports.verifyPayment = async (req, res) => {
  ...
  // For testing: bypass signature verification if it's a mock payment
  if (razorpay_signature.startsWith("mock_signature_")) {
    ...
    if(signature === digest) {
        ...
        try {
            ...
            return res.status(200).json({
                success: true,
                message: "Signature verified are course added",
            });
